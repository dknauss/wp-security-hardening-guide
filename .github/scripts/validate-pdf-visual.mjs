...
const CASES = [
  {
    name: "page-5-running-header-and-threat-landscape",
    page: 5,
    clip: { x: 350, y: 56, width: 800, height: 690 },
  },
  {
    name: "page-10-running-header-and-server-hardening",
    page: 10,
    clip: { x: 350, y: 56, width: 800, height: 690 },
  },
];

const PDF_FILE = "WordPress-Security-Hardening-Guide.pdf";
